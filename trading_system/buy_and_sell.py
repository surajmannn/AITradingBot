...
def sell(ticker, mla, quantity, security_price, balance, total_price, purchase_date, BB_upper, BB_lower, rsi, adx, di_pos, di_neg, volatility, confidence_probability):
    userID = 1          # irrelevant for testing scenario
    position = -1        # 2 indicates Sell position
    values = (userID, ticker, mla, position, quantity, security_price, balance, total_price, purchase_date, BB_upper, BB_lower, rsi, adx, di_pos, di_neg, volatility, confidence_probability)
    data = add_position(values)     # database handler call
    return data

# This function sends close signal to database
def close(ticker, mla, quantity, security_price, balance, total_price, purchase_date, BB_upper, BB_lower, rsi, adx, di_pos, di_neg, volatility):
    userID = 1                      # irrelevant for testing scenario
...
def close_stoploss(ticker, mla, quantity, security_price, balance, total_price, purchase_date, BB_upper, BB_lower, rsi, adx, di_pos, di_neg, volatility):
    userID = 1                      # irrelevant for testing scenario
