...
def add_metrics(ticker, ml_model, training_start_date, training_end_date, accuracy, roc_auc):
    userID = 1          # irrelevant for test scenario
    values = (userID, ticker, ml_model, training_start_date, training_end_date, accuracy, roc_auc)
