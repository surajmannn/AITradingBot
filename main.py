...
def main():
    ...
    """GBPUSD = Run_Trading(ticker='GBPUSD=X', data_period='5d', interval='1m', confidence_level=0.57, desired_model=1, simulation_range=5,
                             rsi_oversold=30, rsi_overbought=70, adx_extreme_val=35, DI_extreme_val=75, volatility_range=20, min_di_level=15, stop_loss=1)
    ...
    """EURUSD = Run_Trading(ticker='EURUSD=X', data_period='5d', interval='1m', confidence_level=0.57, desired_model=1, simulation_range=5, 
                         rsi_oversold=30, rsi_overbought=70, adx_extreme_val=35, DI_extreme_val=75, volatility_range=20, min_di_level=15, stop_loss=0.1)
    ...
    '''USDJPY = Run_Trading(ticker='USDJPY=X', data_period='5d', interval='1m', confidence_level=0.57, desired_model=1, simulation_range=5,
                             rsi_oversold=29, rsi_overbought=71, adx_extreme_val=35, DI_extreme_val=75, volatility_range=20, min_di_level=10, stop_loss=0.1)
    ...
    """EURJPY = Run_Trading(ticker='EURJPY=X', data_period='5d', interval='1m', confidence_level=0.57, desired_model=1, simulation_range=5,
                             rsi_oversold=29, rsi_overbought=71, adx_extreme_val=35, DI_extreme_val=75, volatility_range=25, min_di_level=10, stop_loss=0.1)
    balance = EURJPY.run_trading_simulation()"""

    EURGBP = Run_Trading(ticker='EURGBP=X', data_period='5d', interval='1m', confidence_level=0.57, desired_model=1, simulation_range=5,
                             rsi_oversold=30, rsi_overbought=70, adx_extreme_val=35, DI_extreme_val=75, volatility_range=15, min_di_level=10, stop_loss=1)
