...
def main():
    ...
    GBPUSD = Run_Trading(ticker='GBPUSD=X', data_period='5d', interval='1m', confidence_level=0.5, desired_model=4, simulation_range=17,
    ...
    USDJPY = Run_Trading(ticker='USDJPY=X', data_period='5d', interval='1m', confidence_level=0.55, desired_model=4, simulation_range=17,
                             rsi_oversold=30, rsi_overbought=70, adx_extreme_val=35, DI_extreme_val=75, volatility_range=15, min_di_level=10, stop_loss=0.15)
    balance = USDJPY.run_trading_simulation()

    print("\nFinal Balance: ", balance)

    AUDUSD = Run_Trading(ticker='AUDUSD=X', data_period='5d', interval='1m', confidence_level=0.5, desired_model=4, simulation_range=17,
